...
public static partial class ThatNullableTimeOnly
{
	...
	/// </summary>
	public static TimeToleranceResult<TimeOnly?, IExpectSubject<TimeOnly?>> IsAfter(
	...
	/// </summary>
	public static TimeToleranceResult<TimeOnly?, IExpectSubject<TimeOnly?>> IsNotAfter(
		this IExpectSubject<TimeOnly?> source,
		TimeOnly? unexpected)
	{
		TimeTolerance tolerance = new();
