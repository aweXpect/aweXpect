...
public static partial class ThatNullableTimeOnlyShould
{
	...
	/// </summary>
	public static TimeToleranceResult<TimeOnly?, IThatShould<TimeOnly?>> BeOnOrBefore(
	...
	/// </summary>
	public static TimeToleranceResult<TimeOnly?, IThatShould<TimeOnly?>> NotBeOnOrBefore(
		this IThatShould<TimeOnly?> source,
		TimeOnly? unexpected)
	{
		TimeTolerance tolerance = new();
