...
public static partial class ThatTimeOnly
{
	...
	/// </summary>
	public static TimeToleranceResult<TimeOnly, IExpectSubject<TimeOnly>> IsOnOrAfter(
	...
	/// </summary>
	public static TimeToleranceResult<TimeOnly, IExpectSubject<TimeOnly>> IsNotOnOrAfter(
		this IExpectSubject<TimeOnly> source,
		TimeOnly? unexpected)
	{
		TimeTolerance tolerance = new();
