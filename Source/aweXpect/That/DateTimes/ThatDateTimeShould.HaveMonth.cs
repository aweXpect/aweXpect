...
public static partial class ThatDateTimeShould
{
	...
	/// </summary>
	public static AndOrResult<DateTime, IThatShould<DateTime>> HaveMonth(this IThatShould<DateTime> source,
		int? expected)
	...
	/// </summary>
	public static AndOrResult<DateTime, IThatShould<DateTime>> NotHaveMonth(
