...
public static partial class ThatNullableDateTime
{
	...
	/// </summary>
	public static AndOrResult<DateTime?, IExpectSubject<DateTime?>> HasHour(this IExpectSubject<DateTime?> source,
		int? expected)
	...
	/// </summary>
	public static AndOrResult<DateTime?, IExpectSubject<DateTime?>> DoesNotHaveHour(
