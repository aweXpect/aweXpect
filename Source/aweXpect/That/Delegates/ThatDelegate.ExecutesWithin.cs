...
public static partial class ThatDelegate
{
	...
	public static ExpectationResult<TValue> ExecutesWithin<TValue>(
		...
		=> new(source.ThatIs().ExpectationBuilder
			.AddConstraint(_ => new ExecutesWithinConstraint<TValue>(duration)));
	...
	public static ExpectationResult ExecutesWithin(
		...
		TimeSpan duration)
		=> new(source.ThatIs().ExpectationBuilder
			.AddConstraint(_ => new ExecutesWithinConstraint(duration)));
	...
	public static ExpectationResult<TValue> DoesNotExecuteWithin<TValue>(
		...
		TimeSpan duration)
		=> new(source.ThatIs().ExpectationBuilder
			.AddConstraint(_ => new DoesNotExecuteWithinConstraint<TValue>(duration)));
	...
	public static ExpectationResult DoesNotExecuteWithin(
		...
		TimeSpan duration)
		=> new(source.ThatIs().ExpectationBuilder
			.AddConstraint(_ => new DoesNotExecuteWithinConstraint(duration)));
