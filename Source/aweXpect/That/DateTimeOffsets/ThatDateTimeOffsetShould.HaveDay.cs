...
public static partial class ThatDateTimeOffsetShould
{
	...
	/// </summary>
	public static AndOrResult<DateTimeOffset, IThatShould<DateTimeOffset>> HaveDay(
	...
	/// </summary>
	public static AndOrResult<DateTimeOffset, IThatShould<DateTimeOffset>> NotHaveDay(
		this IThatShould<DateTimeOffset> source,
		int? unexpected)
