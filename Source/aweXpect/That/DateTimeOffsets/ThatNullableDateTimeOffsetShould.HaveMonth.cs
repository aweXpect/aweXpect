...
public static partial class ThatNullableDateTimeOffsetShould
{
	...
	/// </summary>
	public static AndOrResult<DateTimeOffset?, IThatShould<DateTimeOffset?>> HaveMonth(
	...
	/// </summary>
	public static AndOrResult<DateTimeOffset?, IThatShould<DateTimeOffset?>> NotHaveMonth(
		this IThatShould<DateTimeOffset?> source,
		int? unexpected)
