...
public static partial class ThatDateTimeOffsetShould
{
	...
	/// </summary>
	public static AndOrResult<DateTimeOffset, IThatShould<DateTimeOffset>> HaveMillisecond(
	...
	/// </summary>
	public static AndOrResult<DateTimeOffset, IThatShould<DateTimeOffset>> NotHaveMillisecond(
		this IThatShould<DateTimeOffset> source,
		int? unexpected)
