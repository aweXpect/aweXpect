...
public static partial class ThatEnumerableShould
{
	...
	/// </summary>
	public static CollectionOrderResult<TItem, IEnumerable<TItem>, IThatShould<IEnumerable<TItem>>> BeInAscendingOrder<TItem>(
	...
	///     Verifies that the collection is in ascending order.
	/// </summary>
	public static CollectionOrderResult<TMember, IEnumerable<TItem>, IThatShould<IEnumerable<TItem>>> BeInAscendingOrder<
		TItem, TMember>(
		this IThatShould<IEnumerable<TItem>> source,
