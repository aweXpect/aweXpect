...
public static partial class ThatAsyncEnumerable
{
	...
	/// </summary>
	public static BetweenResult<ItemsResult<AndOrResult<IAsyncEnumerable<TItem>, IExpectSubject<IAsyncEnumerable<TItem>>>>> Between<TItem>(
		this IThatHas<IAsyncEnumerable<TItem>> source,
		int minimum)
		=> new(maximum => new(new AndOrResult<IAsyncEnumerable<TItem>, IExpectSubject<IAsyncEnumerable<TItem>>>(
