...
public sealed partial class ThatNumber
{
	public sealed partial class Is
	{
		public sealed class WithinTests
		{
			...
			{
				async Task Act()
					=> await That(subject).Is(expected).Within(1);
				...
				double subjectValue, double expectedValue)
			{
				...
				async Task Act()
					=> await That(subject).Is(expected).Within(new decimal(0.1));
			...
			{
				async Task Act()
					=> await That(subject).Is(expected).Within(0.11);
			...
			{
				async Task Act()
					=> await That(subject).Is(expected).Within(0.1);
			...
			{
				async Task Act()
					=> await That(subject).Is(expected).Within(0.11F);
			...
			{
				async Task Act()
					=> await That(subject).Is(expected).Within(0.1F);
