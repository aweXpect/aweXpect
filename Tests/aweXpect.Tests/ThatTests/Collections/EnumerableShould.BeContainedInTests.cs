		...
		public sealed class ProperlyInAnyOrderTests
		{
			...
			public async Task CompletelyDifferentCollections_ShouldFail()
			{
				...
				await That(Act).Should().Throw<XunitException>()
					.WithMessage("""
					             Expected subject to
					             be contained in collection expected and at least one item less in any order,
					             but it was completely different: [
					               1,
					               2,
					               3,
		...
		public sealed class ProperlyInAnyOrderIgnoringDuplicatesTests
		{
			...
			public async Task CompletelyDifferentCollections_ShouldFail()
			{
				...
				await That(Act).Should().Throw<XunitException>()
					.WithMessage("""
					             Expected subject to
					             be contained in collection expected and at least one item less in any order ignoring duplicates,
					             but it was completely different: [
					               1,
					               2,
					               3,
		...
		public sealed class ProperlyInSameOrderTests
		{
			...
			public async Task CompletelyDifferentCollections_ShouldFail()
			{
				...
				await That(Act).Should().Throw<XunitException>()
					.WithMessage("""
					             Expected subject to
					             be contained in collection expected and at least one item less in order,
					             but it was completely different: [
					               1,
					               2,
					               3,
		...
		public sealed class ProperlyInSameOrderIgnoringDuplicatesTests
		{
			...
			public async Task CompletelyDifferentCollections_ShouldFail()
			{
				...
				await That(Act).Should().Throw<XunitException>()
					.WithMessage("""
					             Expected subject to
					             be contained in collection expected and at least one item less in order ignoring duplicates,
					             but it was completely different: [
					               1,
					               2,
					               3,
